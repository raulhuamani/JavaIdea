...
<ul class="list-group">
    ...
    <li class="list-group-item"><a href="${pageContext.request.contextPath}/categorias">categorias</a></li>
    ...
    <li class="list-group-item"><a href="${pageContext.request.contextPath}/cursos">Tarea cursos</a></li>
</ul>
